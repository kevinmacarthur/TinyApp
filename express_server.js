...
//FUNCTION to check owner of URL
...
app.get("/urls/:id", function (req, res) {
  ...
  if (req.session.user_id === false) {
    ...
    res.send("Error: Requested short url does not exist");
  } else if (!ownUrl(req.session.user_id)) {
    res.send("Error: you do not own the url");
  } else  {
    let templateVars = {
...
app.get("/u/:shortURL", (req, res) => {
  if (urlExists(req.params.shortURL) === false) {
    res.send("Error: Requested short url does not exist");
  } else {
